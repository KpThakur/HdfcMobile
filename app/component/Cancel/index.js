...
export default function index(props) {
    ...
    return (
        <Modal animationType="slide"
            transparent={true}
            visible={popup} >
                <View style={{flex:1,position:"absolute",backgroundColor: 'rgba(100,100,100, 0.8)',height:"100%",width:"100%"}}>
            <View style={{ justifyContent: "space-between",marginTop:"50%",backgroundColor:"#fff"

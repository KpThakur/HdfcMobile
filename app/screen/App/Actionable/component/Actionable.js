                        ...
                        <View style={styles.main}>
                            {
                                data.actionable[0].image ?
                                    <View style={styles.head}>
                                        <Image source={{ uri: data.baseURL + data.actionable[0].image }} style={styles.img} />
                        ...
                        <Image source={CAMERA} style={styles.icon_img}/>
                            ...
                            <View style={styles.body}>
                                    ...
                                    data.actionable[0].score_range ?
                                        <View>
                                            ...
                                            <View style={{ alignItems: "center" }}>
                                                <Text>Rating: <Text style={{ color: PRIMARY_BLUE_COLOR, fontFamily: FONT_FAMILY_SEMI_BOLD }}>{data.actionable[0].score_range}</Text></Text>
                                            </View>
                                            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                                                <View style={{ flex: 0.5, justifyContent: "center", alignItems: "flex-end" }}>
                                                    <Text style={{ color: PRIMARY_BLUE_COLOR, fontFamily: FONT_FAMILY_SEMI_BOLD }}> {data.actionable[0].score_range_from}</Text>
                                                </View>
                                                <Slider
                                                ...
                                                />
                                                <View style={{ flex: 0.5 }}>
                                                    <Text style={{ color: PRIMARY_BLUE_COLOR, fontFamily: FONT_FAMILY_SEMI_BOLD }}>{data.actionable[0].score_range_to}</Text>
                                                </View>
                                            </View>
                                        </View> : null
                                }
                                <View style={{ marginVertical: 10 }}>
                                    ...
                                    <Text style={styles.b_txt}>{data.actionable[0].actionable_remark}</Text>
                                </View>
                        ...
                        <View style={styles.main}>
                            {
                                data.RM[0].image_capture ?
                                    <View style={styles.head}>
                                        <Image source={{ uri: data.baseURL + data.RM[0].image_capture }} style={styles.img} />
                                        {/* <TouchableOpacity style={styles.camera_icon}>
                    <Image source={CAMERA} style={styles.icon_img}/>
                </TouchableOpacity> */}
                                    </View> :
                                ...
                                </View>
                                {
                                    data.RM[0].score_range ?
                                        <View>
                                            <Text style={styles.txt}>Rating</Text>
                                            <View style={{ alignItems: "center" }}>
                                                <Text>Rating: <Text style={{ color: PRIMARY_BLUE_COLOR, fontFamily: FONT_FAMILY_SEMI_BOLD }}>{data.RM[0].score_range}</Text></Text>
                                            </View>
                                            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                                                <View style={{ flex: 0.5, justifyContent: "center", alignItems: "flex-end" }}>
                                                    <Text style={{ color: PRIMARY_BLUE_COLOR, fontFamily: FONT_FAMILY_SEMI_BOLD }}> {data.RM[0].score_range_from}</Text>
                                                </View>
                                                <Slider
                                                    style={{ height: 40, flex: 5 }}
                                                ...
                                                />
                                                <View style={{ flex: 0.5 }}>
                                                    <Text style={{ color: PRIMARY_BLUE_COLOR, fontFamily: FONT_FAMILY_SEMI_BOLD }}>{data.RM[0].score_range_to}</Text>
                                                </View>
                                            </View>
                                        </View> : null
                                }

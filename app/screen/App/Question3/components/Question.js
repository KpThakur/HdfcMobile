...
import { STAR, UNSTAR, ARROW, CHECKED_ICON,INFO_ICON,UNCHECKED_ICON } from "../../../../utils/constant";
                        ...
                        <View style={styles.brnchmannme}>
                            ...
                            <Text style={styles.txt}>Answer the following question</Text>
                                <View style={{ flexDirection: "row",marginBottom:5 }}>
                                    <Image source={CHECKED_ICON} style={{ width: 20, height: 20, marginRight: 5 }} />
                                    <Text style={styles.txt}>Lorem sadi osido</Text>
                                </View>
                                <View style={{ flexDirection: "row",marginBottom:5 }}>
                                <Image source={UNCHECKED_ICON} style={{ width: 20, height: 20, marginRight: 5 }} />
                                    <Text style={styles.txt}>Lorem sadi osido</Text>
                                </View>
                                <View style={{ flexDirection: "row",marginBottom:5 }}>
                                <Image source={UNCHECKED_ICON} style={{ width: 20, height: 20, marginRight: 5 }} />

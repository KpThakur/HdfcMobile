...
import ConfirmationalModel from './component/ConfirmationModel';
export default function Index({navigation}) {
  ...
  const ShowAlert = message => {
    Alert.alert('Schedule Aduit', message);
  };
  const validation = () => {
    if (!cityId) {
